...
public class Chaper01Application {

	public static void main(String[] args) {
		//SpringApplication.run(Chaper01Application.class, args);
		
		SpringApplication springApplication = new SpringApplication(Chaper01Application.class);
